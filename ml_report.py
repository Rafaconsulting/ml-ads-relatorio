...
def load_organico(organico_file) -> pd.DataFrame:
    ...
    for c in [
        "Visitas", "Qtd_Vendas", "Compradores", "Unidades", "Vendas_Brutas",
...
# =========================
# CAMPANHAS: DIARIO vs CONSOLIDADO
# =========================
...
def load_campanhas_diario(campanhas_file) -> pd.DataFrame:
    ...
    camp["Desde"] = pd.to_datetime(camp.get("Desde"), errors="coerce")
...
def build_tables(
    ...
    enter = enter[[
        "ID", "Codigo_MLB", "Titulo",
        "Conv_Visitas_Vendas", "Visitas", "Qtd_Vendas", "Vendas_Brutas", "Ação"
    ]]
